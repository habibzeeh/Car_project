                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <div class="row py-3 mb-0 w-100">
                            ...
                            <h4 class="font-weight-bold py-3 mb-0 w-50"><?=$show_room->name;?></h4>

                            <div class="w-50">

                                <button  type="button" class="btn btn-lg float-right btn-outline-danger"  onclick="window.location.href='show_room_delete.php?id=<?=$id;?>';">
                                    <span class="far fa-trash-alt"></span>&nbsp;&nbsp;Delete</button>

                                <div class="float-right">&nbsp;</div>

                                <button  type="button" class="btn btn-lg float-right btn-outline-success"  onclick="window.location.href='show_room_edit.php?id=<?=$id;?>';">
                                ...
                                <div class="row no-gutters row-bordered row-border-light h-100">
                                    ...
                                    <div class="d-flex col-md-6 col-lg-4 align-items-center">
                                        <div class="card-body">
                                            <div class="row align-items-center mb-3">
                                                <div class="col-auto">
                                                    <i class="lnr lnr-database text-primary display-1"></i>
                                                </div>
                                                <div class="col">
                                                    <h6 class="text-primary text-large">Capacity</span></h6>
                                                    <h4 class="mt-3 mb-0"><?=$show_room->capacity;?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex col-md-6 col-lg-4 align-items-center">
                                        <div class="card-body">
                                            <div class="row align-items-center mb-3">
                                                <div class="col-auto">
                                                    <i class="lnr lnr-map-marker text-primary display-1"></i>
                                                </div>
                                                <div class="col">
                                                    <h6 class="text-primary text-large">Location</span></h6>
                                                    <h4 class="mt-3 mb-0"><?=$show_room->location;?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
