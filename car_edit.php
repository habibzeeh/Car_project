                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <div class="row py-3 mb-0 w-100">
                            ...
                            <h4 class="font-weight-bold py-3 mb-0 w-50">Update Car</h4>
                        ...
                        <div class="container-fluid flex-grow-1 container-p-y">
                            ...
                            <form action="car_edit.php?id=<?=$id;?>" method="post">
                                ...
                                <button type="submit" class="btn btn-primary float-right btn-primary">
                                    <span class="far fa-edit"></span>&nbsp;&nbsp;Update Car</button>
                            </form>
                        </div>
